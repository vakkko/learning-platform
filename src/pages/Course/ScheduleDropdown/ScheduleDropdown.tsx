      ...
      <button onClick={handleButtonClick} className="btn-schedule">
        <div className="number-and-session-type">
          ...
          {num === 3 && (
            ...
            >
              <path
                d="M13.9946 2.15234C17.1109 2.15234 20.0997 3.3902 22.3032 5.59375C24.5068 7.7973 25.7446 10.7861 25.7446 13.9023C25.7446 15.4453 25.4405 16.973 24.8501 18.3984C24.2596 19.824 23.3943 21.1198 22.3032 22.2109C21.2121 23.302 19.9163 24.1673 18.4907 24.7578C17.0652 25.3482 15.5375 25.6523 13.9946 25.6523C12.4517 25.6523 10.924 25.3482 9.49854 24.7578C8.07296 24.1673 6.77712 23.302 5.68604 22.2109C4.59495 21.1198 3.72965 19.824 3.13916 18.3984C2.54876 16.973 2.24463 15.4453 2.24463 13.9023C2.24463 10.7861 3.48248 7.7973 5.68604 5.59375C7.88959 3.3902 10.8783 2.15234 13.9946 2.15234Z"
                stroke={showDropdown ? "#130E67" : `#8A8A8A`}
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
              />
              <path
                d="M10.3223 11.4715C10.3223 8.11886 17.6774 8.11886 17.6774 11.4715C17.6774 11.4715 17.6774 14.0009 13.9998 14.0009C17.6774 14.0009 17.6774 16.5302 17.6774 16.5302C17.6774 19.8829 10.3223 19.8829 10.3223 16.5302"
                stroke={showDropdown ? "#0A0836" : "#8A8A8A"}
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
          ...
          <span className={showDropdown ? "active" : ""}>{heading}</span>
        </div>
        <motion.svg
          width="16"
          height="8"
